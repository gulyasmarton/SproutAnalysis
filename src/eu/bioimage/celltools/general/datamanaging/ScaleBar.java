...
public class ScaleBar {
	...
	public static final String[] colors = {"White","Black","Light Gray","Gray","Dark Gray","Red","Green","Blue","Yellow"};
	...
	public static int defaultBarHeight = 4;
	public static int barHeightInPixels = defaultBarHeight;
	public String location = locations[LOWER_RIGHT];
	public String color = colors[0];
	public String bcolor = bcolors[0];
